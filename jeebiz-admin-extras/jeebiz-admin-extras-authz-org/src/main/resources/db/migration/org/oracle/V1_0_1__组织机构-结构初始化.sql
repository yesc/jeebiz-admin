...
create table SYS_AUTHZ_ORG_LIST (
	ORG_ID 		VARCHAR2(32) default sys_guid() not null,
  	...
  	ORG_USERID  VARCHAR2(32) not null,
...
comment on column SYS_AUTHZ_ORG_LIST.ORG_USERID  is '机构创建人ID';
...
(
	...
	DEPT_ID   		VARCHAR2(32) default sys_guid() not null,
  	...
  	DEPT_USERID		VARCHAR2(32) not null,
...
comment on column SYS_AUTHZ_ORG_DEPT.DEPT_USERID is '部门创建人ID';
