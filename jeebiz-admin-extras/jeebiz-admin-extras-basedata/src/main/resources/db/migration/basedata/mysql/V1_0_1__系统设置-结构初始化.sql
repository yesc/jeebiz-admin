...
-- ----------------------------
-- Table structure for SYS_EXTRAS_PAIRGROUP
-- ----------------------------
DROP TABLE IF EXISTS `SYS_EXTRAS_PAIRGROUP`;
CREATE TABLE `SYS_EXTRAS_PAIRGROUP` (
  `G_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '数据分组ID',
  ...
  PRIMARY KEY (`G_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='基础数据分组信息表';
