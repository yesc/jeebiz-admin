...
<head>
    ...
    <style>
        ...
        .bg{
            background: url("/assets/images/404bg.jpg") no-repeat center;
...
<body>
    ...
    <div class="bg">
        <div class="bug">
            <span>对不起，你所访问的地址不存在！</span>
            <p>将在<span id="time">10</span>秒后自动转入<a href="" class="btn-bug">网站首页</a> </p>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $(".bug").css('margin-left', bugWidth / 2);
