        ...
        */
        toRMBString:function() {
            ...
            if (Number(this) > 99999999999.99) {
             ...
             var rmb_digits = messages.rmb_digits;
             var rmb_suffix = messages.rmb_suffix;
             var weiShu = messages.rmb_unit2;
             var rmb_vunit = messages.rmb_vunit;
            ...
            for (var i = 0; i < str.length; i++) {
                ...
                result = rmb_digits[n] + "" + messages.rmb_unit3[i] + result;
            }
